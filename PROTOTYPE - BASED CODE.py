...
async def dashboard_carousel_task():
    ...
    global admin_session_active, pending_registration, last_registration_result
    global pending_switch_id
...
async def handle_client(reader_stream, writer_stream):
    ...
    try:
        ...
        elif path == '/api/stage_registration' and method == 'POST' and admin_session_active:
            try:
        ...
        elif path == '/api/force_return' and method == 'POST' and admin_session_active:
            try:
                req = json.loads(body)
                tool_id = req.get("id")
        ...
        elif path == '/api/bulk_action' and method == 'POST' and admin_session_active:
            try:
                req = json.loads(body)
                action = req.get("action")
                ids = req.get("ids", [])
        ...
        elif path == '/api/delete' and method == 'POST' and admin_session_active:
            try:
